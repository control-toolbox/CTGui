...
private slots:
   ...
   // void multiBounds_ShowContextMenu(void);
   // void multiBounds_menuSelection(QAction* action);
  //  void add_multiBounds_item(int index);
  //  void delete_multiBounds_item(int index);
    ...
    // Optimization slots
    void add_ipopt_item(int index);
    void delete_ipopt_item(int index);
    ...
    // Ipopt slots
    void Ipopt_ShowContextMenu();
    void Ipopt_menuSelection(QAction* action);
...
private:
    ...
    //QStandardItemModel *model_multiBounds;
    ...
    int saveNames(void);
    int saveBounds(void);
    int saveSingleBounds(void);
   // int saveMultiBounds(void);
    ...
    /** @name Bounds */
    void askBoundOptions(void);
    int loadDefinitionBounds(void);
    int initializeDefinitionBounds(void);
    int initializeDefinitionMultiBounds(void);
